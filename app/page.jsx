...
export default function Home() {
  return (
    <div>
      ...
      <p> 3. Full Components are premium UIs made from basic component blocks that can be purchased one-time or through monthly subscription. This pricing structure supports the development and maintenance of high-quality UIs. </p>
      ...
      <p> 7. Only the latest version of Full Components will have access to our SaaS, ensuring seamless integration with our AI models and database services while preventing piracy.</p>
