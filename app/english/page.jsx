  ...
  return (
    <div>
      ...
      <div style={{ margin: "auto", width: "40%" }}>
        <div className="chart-wrapper mx-auto flex max-w-6xl justify-center gap-6 p-6 sm:flex-row sm:p-8">
          <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
            <Card className="lg:max-w-md" x-chunk="charts-01-chunk-0">
              ...
              <CardFooter className="flex-col items-start gap-1">
                <CardDescription>
                  Over the past 7 days, you have learned{" "}
                  <span className="font-medium text-foreground">82</span> lessons.
                </CardDescription>
                <CardDescription>
                  You need{" "}
                  <span className="font-medium text-foreground">10</span> more
                  lessons to reach your goal.
                </CardDescription>
              </CardFooter>
            </Card>
            <Card
            ...
            >
              <CardHeader className="flex flex-row items-center gap-4 space-y-0 pb-2 [&>div]:flex-1">
                <div>
                  <CardDescription>Speech Speed</CardDescription>
                ...
                <div>
                  <CardDescription>Word Variability</CardDescription>
                  <CardTitle className="flex items-baseline gap-1 text-4xl tabular-nums">
                    35
                    <span className="text-sm font-normal tracking-normal text-muted-foreground">
                      words
          ...
          <div className="grid w-full flex-1 gap-6 lg:max-w-[20rem]">
            ...
            >
              <CardHeader>
                <CardTitle>Speech Progress</CardTitle>
                <CardDescription>
            ...
            >
              <CardHeader className="p-4 pb-0">
                <CardTitle>Speech Error</CardTitle>
                <CardDescription>
                  Over the last 7 days, you have made 10 errors a lesson
                </CardDescription>
              </CardHeader>
          ...
          <div className="grid w-full flex-1 gap-6">
            ...
            >
              <CardHeader className="space-y-0 pb-0">
                <CardDescription>Speech Analysis</CardDescription>
                <CardTitle className="flex items-baseline gap-1 text-4xl tabular-nums">
                  8
                  <span className="font-sans text-sm font-normal tracking-normal text-muted-foreground">
                    min
